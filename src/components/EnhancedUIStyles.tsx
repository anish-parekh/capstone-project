...
export const PrimaryButton = styled(EnhancedButton)(({ theme }) => ({
...
export const SecondaryButton = styled(EnhancedButton)(({ theme }) => ({
...
export const EnhancedSelect = styled(Select)(({ theme }) => ({
  borderRadius: '6px',
...
export const EnhancedTableHead = styled(TableHead)(({ theme }) => ({
  backgroundColor: '#222222',
  '& .MuiTableCell-head': {
    color: '#ffffff',
    fontWeight: 600,
...
export const EnhancedTableCell = styled(TableCell)(({ theme }) => ({
  padding: '12px 16px',
  borderBottom: '1px solid rgba(224, 224, 224, 0.5)',
}));

// Enhanced Table Row with better hover effects
export const EnhancedTableRow = styled(TableRow)(({ theme }) => ({
